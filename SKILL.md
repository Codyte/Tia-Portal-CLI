...
name: tia
description: >-
  Dirigir o TIA Portal (Siemens) pela linha de comando via Openness — CLI `tia`, 72 verbos com
...
| Preciso de | Arquivo |
|---|---|
| assinatura dos 72 verbos | `$env:TIA_CLI_HOME\docs\VERBS.md` (~90 linhas, gerado do help) |
