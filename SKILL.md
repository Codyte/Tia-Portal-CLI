...
name: tia
description: >-
  Dirigir o TIA Portal (Siemens) pela linha de comando via Openness — CLI `tia`, 98 verbos com
...
| Preciso de | Arquivo |
|---|---|
| assinatura dos 98 verbos | `$env:TIA_CLI_HOME\docs\VERBS.md` (~90 linhas, gerado do help) |
