# __navi__ · repo tree — 146 files in 33 folders
...
PADRAO.md(191)  PLANO.md(364)  projeto-real-fase-A.md(76)
...
_common.ps1(66)  clone-hw.ps1(28)  export-fixtures.ps1(38)  init.ps1(81)  prep-project.ps1(18)  raio-x.ps1(29)  rebuild.ps1(51)  setup-tasks.ps1(45)  smokeloop.ps1(45)  taskrun.ps1(41)  tia.ps1(8)  use-project.ps1(23)  whitelist.ps1(25)
...
## `workspace/exports/` (1 files)
OB_MOLDE_ALARMES.explain.txt(5)
...
err-b8264655.txt(0)  err-t1.txt(0)  err.txt(0)  exit-b8264655.txt(1)  exit-t1.txt(1)  exit.txt(1)  out-b8264655.txt(11)  out-t1.txt(11)  out.txt(11)  result-err.txt(0)  result.txt(5)
