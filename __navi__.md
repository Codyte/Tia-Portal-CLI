# __navi__ · repo tree — 157 files in 34 folders
...
## `workspace/` (6 files) → __navi__.md
export-padrao.json(359)  fw-help.txt(0)  setup-log.txt(33)  tasks-check.txt(7)  whitelist-check.txt(2)  wl-run.txt(4)
...
## `workspace/exports/` (5 files)
FC_ALARMES_PRELIMINAR_P_GM_01.explain.txt(38)  OB_MOLDE_ALARMES.explain.txt(5)  OB_MOLDE_PARTIDAS.explain.txt(4)  Paineis Intertravamento.explain.txt(81)  Resets.explain.txt(45)
...
## `workspace/taskio/` (16 files)
err-4e4e73fd.txt(0)  err-9a6dc72a.txt(0)  err-b8264655.txt(0)  err-t1.txt(0)  err.txt(0)  exit-4e4e73fd.txt(1)  exit-b8264655.txt(1)  exit-t1.txt(1)  exit.txt(1)  out-4e4e73fd.txt(0)  out-9a6dc72a.txt(0)  out-b8264655.txt(11)  out-t1.txt(11)  out.txt(11)  result-err.txt(0)  result.txt(5)
