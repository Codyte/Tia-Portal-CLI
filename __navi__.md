...
## `docs/` (2 files)
PLANO.md(169)  projeto-real-fase-A.md(76)

## `docs/examples/` (5 files)
batch.json(6)  gen-all.json(8)  profinet.json(9)  replicate-fc.json(8)  replicate-instruments.json(6)
