...
- `insert-telegram --device X --number N [--type Main|Supplementary|Safety|Torque|Edge] [--item I] [--drive-object D] [--apply]  (telegrama de drive NÃO é submódulo de catálogo — plug-module não coloca)`
